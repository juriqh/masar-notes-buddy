    ...
    try {
      ...
      notes?.forEach(note => {
        countMap[note.class_code] = (countMap[note.class_code] || 0) + 1;
          <Card className="border-0 modern-shadow hover-lift animate-fade-in bg-white dark:bg-slate-800" style={{ animationDelay: '0.1s' }}>
      ...
      <div className="w-full p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="bg-gradient-to-r from-coral-pink to-coral-pink/80 text-black">
                  <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Notes Uploaded</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{stats.notesUploaded}</p>
          ...
          <Card className="border-0 modern-shadow hover-lift animate-fade-in bg-white dark:bg-slate-800" style={{ animationDelay: '0.2s' }}>
            <CardContent className="p-6">
          <Card className="bg-gradient-to-r from-creamy-yellow to-creamy-yellow/80 text-black">
            <CardContent className="p-4">
                  <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Reminders Set</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{stats.remindersSet}</p>
                <div>
          ...
          <Card className="border-0 modern-shadow hover-lift animate-fade-in bg-white dark:bg-slate-800" style={{ animationDelay: '0.3s' }}>
            <CardContent className="p-6">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                  <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Study Streak</p>
                  <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">{stats.studyStreak}</p>
      ...
      <div className="w-full px-4 py-8">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-6">
              ...
              <Card className="modern-shadow-lg border-0 hover-lift animate-scale-in bg-white dark:bg-slate-800">
                <CardHeader className="pb-4">
                  <CardTitle className="flex items-center gap-3 text-lg">
                    <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center">
                      <Clock className="h-5 w-5 text-white" />

                    <span className="text-slate-900 dark:text-white font-semibold">Next Class</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <CardHeader className="pb-6">
                <CardTitle className="flex items-center gap-3 text-xl">
                    ...
                    <span className="text-slate-900 dark:text-white font-semibold">{t('todaysSchedule')}</span>
                    <div className="flex items-center gap-1 mt-1">
                        <Badge className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white border-0">
                      <span className="w-1 h-1 bg-slate-400 rounded-full"></span>
                      <span className="text-slate-500 dark:text-slate-400 text-sm">{todayDayOfWeek}</span>
              ...
              <CardContent className="p-6">
                  ...
                  <div className="flex items-center justify-center py-12">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-700 rounded-lg p-3">
                        <Clock className="h-4 w-4 text-slate-600 dark:text-slate-400" />
                        <span className="font-medium text-slate-900 dark:text-white">
                      <CalendarDays className="h-10 w-10 text-slate-400" />
            </div>
                    <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">No Schedule Uploaded</h3>
                    <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-md mx-auto">Upload your schedule to see your classes and manage your academic life.</p>
                        <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-700 rounded-lg p-3">
                          <MapPin className="h-4 w-4 text-slate-600 dark:text-slate-400" />
                          <span className="font-medium text-slate-900 dark:text-white">{nextClass.location}</span>
            ...
            <ul className="text-sm text-slate-700 dark:text-slate-300 space-y-2">
              <li className="flex items-start gap-2">
                  <div className="text-center py-12">
                    <div className="w-20 h-20 bg-gradient-to-br from-emerald-100 to-teal-200 dark:from-emerald-900 dark:to-teal-800 rounded-2xl flex items-center justify-center mx-auto mb-6">
                      <CalendarDays className="h-10 w-10 text-emerald-600 dark:text-emerald-400" />
              <li className="flex items-start gap-2">
            <Card className="modern-shadow-lg border-0 hover-lift animate-scale-in bg-white dark:bg-slate-800" style={{ animationDelay: '0.2s' }}>
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-3 text-lg">
                  <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center">
                    <Award className="h-5 w-5 text-white" />
                {t('instruction3')}
                  <span className="text-slate-900 dark:text-white font-semibold">Study Progress</span>
              <li className="flex items-start gap-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    <span className="font-bold">{stats.notesUploaded}</span>
            <div key={classCode} className="flex items-center gap-2 p-2 rounded-md bg-gray-50">
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-slate-700">
                    ...
                    <span className="text-slate-600 dark:text-slate-400 font-medium">Study Streak</span>
